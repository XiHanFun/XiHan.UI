const e=`// 自行决定何时取图 | src 是响应式的：进入视口前不提供地址，观察器命中后再换上，状态机立即经过一遍完整加载
...
export default function Demo(): ReactNode {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { root: viewport.current, rootMargin: "24px", threshold: 0.1 },
    );
  ...
  return (
    ...
    >
      ...
      <div ref={host}>
        ...
        <XhImageRoot src={src} alt="报表截图" style={boxStyle}>
          <XhImageImage />
