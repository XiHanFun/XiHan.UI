const t=`// 三档提交按键 | enter 档回车即发送、mod-enter 档只有 Ctrl/Cmd+Enter 发送、none 档两种按法都换行，提交只剩发送按钮
  ...
  return (
    <div style={{ display: "grid", gap: "12px" }}>
      ...
      <XhPromptInputRoot
        ...
        onSubmit={details => setLog(\`enter 档发出：\${details.value}\`)}
      >
      ...
      <XhPromptInputRoot
        ...
        onSubmit={details => setLog(\`mod-enter 档发出：\${details.value}\`)}
      >
      ...
      <XhPromptInputRoot
        ...
        onSubmit={details => setLog(\`none 档发出：\${details.value}\`)}
      >
