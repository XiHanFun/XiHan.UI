const n=`<!-- 浮层底栏 | content 的子节点全由作者写：列装进一层横排容器，底栏与它并列，就横跨了全部列 -->
<xh-cascader
...
>
  <div data-xh-part="root">
    ...
    <div data-xh-part="positioner">
      ...
      <div data-xh-part="content" style="flex-direction: column">
        ...
        >
          <span
            id="cascader-content-footer-count"
            style="color: var(--xh-fg-subtle); font-size: 12px"
          >
            已选 1 条
          </span>
