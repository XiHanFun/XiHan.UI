const e=`// 触屏拖动把手 | 整行起手只认鼠标与笔；触屏要按住行首那个把手才拖得动，代价是那一小块地方不再跟着表格滚。键盘那一路照旧：Tab 进表体后 Alt + 上下键
...
const spacerStyle: CSSProperties = {
  flex: "none",
  inlineSize: "var(--xh-table-row-drag-size, var(--xh-control-indicator-size))",
};
