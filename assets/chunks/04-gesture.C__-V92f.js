const e=`// 双指缩放 | 触屏上两指张开放大、捏合缩小，单指平移；缩放限制在 minScale 与 maxScale 之间
...
export default function Demo(): ReactNode {
  return (
    <XhImageViewerRoot collection={items} minScale={0.5} maxScale={4}>
      <XhImageViewerTrigger>
        <img
          src={items[0]!.src}
          alt={items[0]!.alt}
          style={{ inlineSize: "160px", borderRadius: "8px", cursor: "zoom-in", display: "block" }}
        />
      </XhImageViewerTrigger>
      <XhImageViewerContent>
        <XhImageViewerViewport>
