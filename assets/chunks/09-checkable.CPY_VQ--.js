...
<style>
  ...
  #tree-checkable [data-part="item"][data-selected] > [data-demo-box]::after {
    content: "✓";
  }
</style>
...
<script type="module">
  ...
  tree.selectedValue = ["hz"];
  tree.addEventListener("selection-change", (event) => {
    tree.selectedValue = event.detail.value;
