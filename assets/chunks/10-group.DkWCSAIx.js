  ...
  <xh-menu id="menu-group">
    ...
    <div data-xh-part="positioner">
      <div data-xh-part="content">
        <div role="group" aria-labelledby="menu-group-density">
          <div id="menu-group-density" style="padding: 6px 8px; font-size: 12px; color: var(--xh-fg-muted)">
            行高
          </div>
        ...
        <div role="group" aria-labelledby="menu-group-panel">
          <div id="menu-group-panel" style="padding: 6px 8px; font-size: 12px; color: var(--xh-fg-muted)">
            面板
          </div>
...
<script type="module">
  ...
  function mark(value, on) {
    ...
    item.firstElementChild.textContent = on ? "✓" : "";
  }
