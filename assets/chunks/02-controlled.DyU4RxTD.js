const t=`<!-- 受控 | 传了 step 就由宿主说了算，组件自己不再改步序；切步意图从 step-change 出来，写回才真的切 -->
<div style="display: flex; flex-direction: column; gap: 12px; inline-size: 100%">
  <xh-steps id="steps-controlled" step="1" count="4">
  ...
  <div style="display: flex; align-items: center; gap: 8px">
    ...
    <span>当前 step：<span id="steps-controlled-value">1</span></span>
  </div>
</div>
...
<script type="module">
  ...
  complete.addEventListener("click", () => setStep(4));
<\/script>
`;export{t as default};
