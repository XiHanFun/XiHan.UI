const n=`<!-- 缓动与时长 | duration 定跑多久，easing 定快慢怎么分配；同一段距离四档并排跑，差别一眼可见 -->
<div id="number-animation-easing">
  ...
  <p>
    ease-in：
    <xh-number-animation to="10000" duration="2000" easing="ease-in" separator=",">
      <span data-xh-part="root"></span>
    </xh-number-animation>
  </p>
  <p>
    ease-out：
    <xh-number-animation to="10000" duration="2000" easing="ease-out" separator=",">
      <span data-xh-part="root"></span>
    </xh-number-animation>
  </p>
  <p>
