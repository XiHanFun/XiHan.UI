const a=`// 回退延迟与原生属性 | fallback-delay 决定回退内容多久后才显示，Infinity 表示加载期间一直不显示、只有失败才显示；写在 image 部件上的原生属性照常落到底层图片元素上
...
export default function Demo(): ReactNode {
  return (
    <>
      ...
      <XhImageRoot src={shot} alt="立刻顶上回退内容" style={boxStyle}>
        <XhImageImage />
