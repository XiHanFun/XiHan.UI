  ...
  return (
    <div style={{ display: "flex", flexWrap: "wrap", alignItems: "end", gap: "16px" }}>
      <div style={{ display: "grid", gap: "6px", justifyItems: "center" }}>
        ...
        <XhQrCode value={text} level="Q" pixelSize={176} label="曦寒 UI 文档站二维码">
          <XhQrCodeLogo>
      ...
      <div style={{ display: "grid", gap: "6px", justifyItems: "center" }}>
        <XhQrCode value={text} level="H" moduleShape="rounded" eyeShape="rounded" pixelSize={176} label="曦寒 UI 文档站二维码">
          <XhQrCodeLogo>
