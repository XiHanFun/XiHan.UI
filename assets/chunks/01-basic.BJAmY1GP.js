const t=`<!-- 基础用法 | 渲染成 <time datetime>：文本给人看，datetime 给机器读，两者取自同一个墙钟 -->
<div style="display: flex; flex-direction: column; gap: 8px">
  <!-- 三种写法都收：只写年月日的串按本地零点解读，不会掉到前一天去 -->
  <xh-time value="2026-08-11T09:30:05">
    <time data-xh-part="root"></time>
  </xh-time>

  <xh-time value="2026-08-11">
    <time data-xh-part="root"></time>
  </xh-time>

  <xh-time id="time-basic-stamp">
    <time data-xh-part="root"></time>
  </xh-time>

  <xh-time id="time-basic-date">
    <time data-xh-part="root"></time>
  </xh-time>
</div>
