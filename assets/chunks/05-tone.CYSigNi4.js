const a=`<!-- 语气 | tone 决定已完成与当前这两步的标记、连接线用哪族颜色；示例预置到第 2 步，第 1 步已走完 -->
<div style="display: flex; flex-direction: column; gap: 24px; inline-size: 100%">
  <div>
    ...
    <xh-steps tone="brand" count="3" default-step="1">
  ...
  <div>
    ...
    <xh-steps tone="neutral" count="3" default-step="1">
      <div data-xh-part="root" style="inline-size: 100%">
        <div data-xh-part="list">
          <div data-xh-part="item" value="0">
            <button data-xh-part="trigger">
  ...
  <div>
    ...
    <xh-steps tone="success" count="3" default-step="1">
      <div data-xh-part="root" style="inline-size: 100%">
        <div data-xh-part="list">
          <div data-xh-part="item" value="0">
            <button data-xh-part="trigger">
  ...
  <div>
    ...
    <xh-steps tone="warning" count="3" default-step="1">
      <div data-xh-part="root" style="inline-size: 100%">
        <div data-xh-part="list">
          <div data-xh-part="item" value="0">
            <button data-xh-part="trigger">
  ...
  <div>
    ...
    <xh-steps tone="danger" count="3" default-step="1">
      <div data-xh-part="root" style="inline-size: 100%">
        <div data-xh-part="list">
          <div data-xh-part="item" value="0">
            <button data-xh-part="trigger">
  ...
  <div>
    ...
    <xh-steps tone="info" count="3" default-step="1">
      <div data-xh-part="root" style="inline-size: 100%">
        <div data-xh-part="list">
          <div data-xh-part="item" value="0">
            <button data-xh-part="trigger">
