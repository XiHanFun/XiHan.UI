// 自定义配色 | 不写 variant 时底色与文字色取自组件令牌，逐个实例覆盖就能用上语气表以外的颜色
...
const pillGrape = { ...grape, "--xh-button-radius": "var(--xh-shape-pill)" } as CSSProperties;
...
export default function Demo(): ReactNode {
  return (
    <>
      ...
      <XhButton style={pillGrape}>胶囊葡萄</XhButton>
    </>
  );
}
