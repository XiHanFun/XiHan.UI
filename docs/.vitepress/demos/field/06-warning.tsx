// 提示、警告与错误 | 三档语气各归各的部件：提示与警告都写在描述里，控件的 aria-invalid 保持 false；只有真出错才翻 invalid、错误文案才接进描述链
...
export default function Demo(): ReactNode {
  return (
    <div style={{ display: "grid", gap: "16px", inlineSize: "280px" }}>
      <XhFieldRoot>
        <XhFieldLabel>项目名</XhFieldLabel>
        <XhFieldControl>
          <input defaultValue="xihan-ui" />
        </XhFieldControl>
