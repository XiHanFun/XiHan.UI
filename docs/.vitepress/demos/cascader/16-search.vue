<!-- 搜索 | searchable 让 XhCascaderInput 可用：输入后整条路径连缀过滤，XhCascaderSearchList 的候选替换列视图；上下键走候选、Enter 选中、Escape 先清词再收浮层 -->
...
<template>
  <XhCascaderRoot v-slot="{ levels }" v-model:value="area" :collection="regions" searchable placeholder="试试输入「西湖」">
