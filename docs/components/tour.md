...
`--xh-tour-action-radius` · `--xh-tour-arrow-size` · `--xh-tour-backdrop-bg` · `--xh-tour-backdrop-layer` · `--xh-tour-bg` · `--xh-tour-border` · `--xh-tour-close-bg-active` · `--xh-tour-close-bg-hover` · `--xh-tour-close-radius` · `--xh-tour-close-size` · `--xh-tour-description-fg` · `--xh-tour-fg` · `--xh-tour-gap` · `--xh-tour-icon-size` · `--xh-tour-max-h` · `--xh-tour-max-w` · `--xh-tour-next-bg` · `--xh-tour-next-bg-hover` · `--xh-tour-next-fg` · `--xh-tour-positioner-layer` · `--xh-tour-positioner-padding` · `--xh-tour-progress-fg` · `--xh-tour-progress-font-size` · `--xh-tour-px` · `--xh-tour-py` · `--xh-tour-radius` · `--xh-tour-shadow` · `--xh-tour-skip-trigger-px` · `--xh-tour-spotlight-layer` · `--xh-tour-spotlight-radius` · `--xh-tour-spotlight-ring` · `--xh-tour-spotlight-shroud` · `--xh-tour-title-fg` · `--xh-tour-title-font-size` · `--xh-tour-title-font-weight`
