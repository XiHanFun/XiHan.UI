...
<XhComponentCard src="calendar-picker" name="CalendarPicker" label="日历选择器" href="/components/calendar-picker" />
<XhComponentCard src="calendar-range-picker" name="CalendarRangePicker" label="日历范围选择器" href="/components/calendar-range-picker" />
...
<XhComponentCard src="color-field" name="ColorField" label="颜色字段" href="/components/color-field" />
<XhComponentCard src="color-picker" name="ColorPicker" label="颜色选择器" href="/components/color-picker" />
<XhComponentCard src="color-slider" name="ColorSlider" label="颜色滑块" href="/components/color-slider" />
<XhComponentCard src="color-swatch-picker" name="ColorSwatchPicker" label="颜色色块选择器" href="/components/color-swatch-picker" />
<XhComponentCard src="combobox" name="Combobox" label="组合框" href="/components/combobox" />
<XhComponentCard src="date-field" name="DateField" label="日期字段" href="/components/date-field" />
<XhComponentCard src="date-picker" name="DatePicker" label="日期选择器" href="/components/date-picker" />
<XhComponentCard src="date-range-picker" name="DateRangePicker" label="日期范围选择器" href="/components/date-range-picker" />
...
<XhComponentCard src="text-field" name="TextField" label="文本字段" href="/components/text-field" />
...
<XhComponentCard src="matrix-code" name="MatrixCode" label="二维码" href="/components/matrix-code" />
