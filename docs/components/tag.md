...
`--xh-tag-bg` · `--xh-tag-bg-disabled` · `--xh-tag-border` · `--xh-tag-border-disabled` · `--xh-tag-close-fg` · `--xh-tag-close-radius` · `--xh-tag-close-size` · `--xh-tag-fg` · `--xh-tag-font-size` · `--xh-tag-font-weight` · `--xh-tag-gap` · `--xh-tag-px` · `--xh-tag-py` · `--xh-tag-radius`
