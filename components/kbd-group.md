来源：https://ui.docs.xihanfun.com/components/kbd-group
...
```html
<xh-kbd-group keys="Mod,S" platform="mac"><span data-xh-part="root"></span></xh-kbd-group>
<xh-kbd-group keys="Mod,S" platform="other"><span data-xh-part="root"></span></xh-kbd-group>
```
...
```html
<div style="display: flex; align-items: center; gap: 24px">
  <xh-kbd-group keys="Mod,1" size="sm">
    <span data-xh-part="root"></span>
  </xh-kbd-group>
  <xh-kbd-group keys="Mod,2" size="md">
    <span data-xh-part="root"></span>
  </xh-kbd-group>
  <xh-kbd-group keys="Mod,3" size="lg">
    <span data-xh-part="root"></span>
  </xh-kbd-group>
</div>
```
...
<template>
  <XhKbdGroup :keys="['Mod', 'S']" disabled />
</template>
```
