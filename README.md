...
<p>
  ...
  <img alt="Components" src="https://img.shields.io/badge/Components-129-1f6feb?style=flat-square" />
...
- **129 components** - covering general, layout, navigation, data entry, data display, feedback, overlay and AI chat — eight groups
...
In the box: 129 components with their cores and both adapters, the default skins, design tokens and the theme runtime, the cross-adapter conformance suite, the accessibility sweep and floating-position contract in real Chromium, and the documentation site.
