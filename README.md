...
<p>
  ...
  <img alt="Components" src="https://img.shields.io/badge/Components-133-1f6feb?style=flat-square" />
...
- **133 components** - covering general, layout, navigation, data entry, data display, feedback, overlay and AI chat — eight groups
...
In the box: 133 components with their cores and three adapters, 127 visual-component skins, design tokens and the theme runtime, the cross-adapter conformance suite, the accessibility sweep and floating-position contract in real Chromium, and the documentation site.
