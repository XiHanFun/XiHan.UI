...
const PENDING = {
  ...
  'back-top': ['visible'],
  'calendar-picker': ['value', 'focusedValue', 'visibleMonth', 'panels', 'canGoPrev', 'canGoNext', 'isSelected', 'isUnavailable', 'setValue', 'select', 'focus', 'goToPrevMonth', 'goToNextMonth'],
  'calendar-range-picker': ['value', 'focusedValue', 'visibleMonth', 'panels', 'canGoPrev', 'canGoNext', 'isSelected', 'isUnavailable', 'setValue', 'select', 'focus', 'goToPrevMonth', 'goToNextMonth'],
