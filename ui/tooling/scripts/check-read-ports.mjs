...
const PENDING = {
  ...
  'back-top': ['visible'],
  'calendar-picker': ['value', 'focusedValue', 'visibleMonth', 'canGoPrev', 'canGoNext', 'isSelected', 'isUnavailable', 'setValue', 'select', 'focus', 'goToPrevMonth', 'goToNextMonth'],
  'calendar-range-picker': ['value', 'focusedValue', 'visibleMonth', 'canGoPrev', 'canGoNext', 'isSelected', 'isUnavailable', 'setValue', 'select', 'focus', 'goToPrevMonth', 'goToNextMonth'],
