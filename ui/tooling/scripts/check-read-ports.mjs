...
const PENDING = {
  ...
  'dynamic-input': ['items', 'value', 'count', 'empty', 'atMin', 'atMax', 'canAdd', 'setValue', 'add', 'remove', 'move', 'moveUp', 'moveDown'],
  ...
  'log': ['rows', 'loading', 'atBottom', 'sticking', 'showScrollButton'],
  ...
  'message-feed': ['status', 'atBottom', 'sticking', 'focusedId', 'showScrollButton', 'scrollToItem', 'focusItem'],
  ...
  'popselect': ['open', 'value', 'collection', 'focusedValue', 'canClear', 'isSelected', 'setOpen', 'setValue', 'select', 'clear'],
  ...
  'timer': ['phase', 'value', 'elapsed', 'running', 'paused', 'completed', 'countdown', 'segments', 'segmentText', 'controlAction', 'controlLabel'],
