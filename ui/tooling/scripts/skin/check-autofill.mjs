 ...
 * 库自有彩色面的域落在面的直接子元素上（:where([data-xh-ink-surface] > *)），同属面声明。
 */
const isInkDomainOnly = selector => selector.split(',').every(branch =>
  /^:where\(\[data-xh-ink[^)]*\]\)$/.test(branch.trim()) || branch.trim() === ':where([data-xh-ink-surface] > *)')
