...
//
// 登记表 axis-scope.json 由 `node tooling/scripts/skin/check-axis-declaration.mjs --update`
...
const UPDATE_CMD = 'node tooling/scripts/skin/check-axis-declaration.mjs --update'
