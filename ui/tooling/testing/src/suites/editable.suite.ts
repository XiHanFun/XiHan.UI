    ...
    children: [
      ...
      { part: 'label', tag: 'label', text: '昵称' },
      {
        ...
        children: [
          ...
          { part: 'edit-trigger', tag: 'button', attrs: { 'aria-label': '编辑' } },
          { part: 'submit-trigger', tag: 'button', attrs: { 'aria-label': '确认' } },
          { part: 'cancel-trigger', tag: 'button', attrs: { 'aria-label': '取消' } },
        ],
      },
    ],
  },
  cases: [
    {
      ...
      initial: {
        ...
        parts: {
          ...
          'edit-trigger': { 'hidden': null, 'disabled': null, 'aria-controls': '@part(input)', 'aria-label': '编辑', 'type': 'button' },
          // 收起而不是卸载：节点是作者写的
          'submit-trigger': { 'hidden': '', 'disabled': '', 'aria-label': '确认', 'type': 'button' },
          'cancel-trigger': { 'hidden': '', 'disabled': '', 'aria-label': '取消', 'type': 'button' },
        },
        activeElement: null,
      },
      steps: [
