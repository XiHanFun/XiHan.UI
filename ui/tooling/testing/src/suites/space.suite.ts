...
import { spaceAnatomy, spaceKeyboard } from '@xihan-ui/headless'

// 排版容器，APG 没有对应模式；判据只锁「排布参数如实落到根上、方向与间距恒有值、根上不多写语义」，
// 外加分隔符两端铺出同一种结构。
const APG = 'https://www.w3.org/WAI/ARIA/apg/'

export const spaceSuite: ConformanceSuite = {
  component: 'space',
  anatomy: spaceAnatomy,
  keyboard: spaceKeyboard,
  ...
  cases: [
    {
      name: '缺省：方向落 horizontal、间距落 md，其余排版参数一律不输出',
      spec: { apg: APG },
      initial: {
        parts: {
          root: {
