...
import { dialogSuite, fieldSuite, formSuite, selectSuite, switchSuite } from '../src'
...
const SUITES: ConformanceSuite[] = [dialogSuite, fieldSuite, formSuite, selectSuite, switchSuite]
