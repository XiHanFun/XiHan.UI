...
124 components, each shipping a headless core, a Vue component, a custom element, and a default skin.
...
| `@xihan-ui/headless` | 124 components as anatomy + machine + `connect` — no styles, no framework |
