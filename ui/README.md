...
135 components, each shipping a headless core, Vue and React components, a custom element, and a default skin.
...
| `@xihan-ui/headless` | 135 components as anatomy + machine + `connect` — no styles, no framework |
