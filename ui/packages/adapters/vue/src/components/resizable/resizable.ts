...
export const XhResizableRoot = defineComponent({
  ...
  props: {
    dimensions: { type: Object as PropType<ResizableDimensions> },
    defaultDimensions: { type: Object as PropType<ResizableDimensions> },
    ...
    step: { type: Number },
    keyboardStep: { type: Number },
    keyboardLargeStep: { type: Number },
    edges: { type: Array as PropType<ResizeEdge[]> },
    disabled: Boolean,
    dir: { type: String as PropType<Direction> },
    translations: { type: Object as PropType<Partial<ResizableTranslations>> },
  },
