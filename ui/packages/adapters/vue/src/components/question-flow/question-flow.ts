...
export const XhQuestionFlowRoot = defineComponent({
  ...
  props: {
    questions: { type: Array as PropType<readonly QuestionFlowQuestion[]> },
    index: { type: Number },
    defaultIndex: { type: Number },
    answers: { type: Object as PropType<QuestionFlowAnswers> },
    defaultAnswers: { type: Object as PropType<QuestionFlowAnswers> },
    notes: { type: Object as PropType<QuestionFlowNotes> },
    defaultNotes: { type: Object as PropType<QuestionFlowNotes> },
    status: { type: String as PropType<QuestionFlowStatus> },
    defaultStatus: { type: String as PropType<QuestionFlowStatus> },
    autoAdvance: { type: Boolean, default: undefined },
    autoAdvanceDelay: { type: Number },
    allowSkip: { type: Boolean, default: undefined },
    loop: { type: Boolean, default: undefined },
    variant: { type: String as PropType<ControlVariant> },
    tone: { type: String as PropType<Tone> },
    size: { type: String as PropType<Size> },
    translations: { type: Object as PropType<Partial<QuestionFlowTranslations>> },
  },
  emits: {
