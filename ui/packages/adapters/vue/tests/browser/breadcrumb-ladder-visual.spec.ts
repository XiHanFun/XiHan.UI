  ...
  host.innerHTML = `
    <nav data-scope="breadcrumb" data-part="root">
      <ol data-scope="breadcrumb" data-part="list">
        <li data-scope="breadcrumb" data-part="item"><a data-scope="breadcrumb" data-part="link" href="#a">首页</a></li>
        <li data-scope="breadcrumb" data-part="separator" aria-hidden="true"></li>
        <li data-scope="breadcrumb" data-part="item"><a data-scope="breadcrumb" data-part="link" data-current aria-current="page">订单</a></li>
      </ol>
    </nav>`
...
describe('breadcrumb 链接阶梯与当前页', () => {
  ...
  it('当前页保留 fg-default + medium 字重，悬停与按下都不换面', async () => {
    const [, current] = mount()
