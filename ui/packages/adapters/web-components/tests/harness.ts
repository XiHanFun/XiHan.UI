...
const PUBLIC_EVENTS = ['open-change', 'checked-change', 'clamp-toggle', 'column-preference-change', 'pressed-change', 'node-move', 'row-move', 'tab-move', 'value-change', 'select', 'sort', 'status-change', 'submit', 'stop', 'stick-change', 'download-complete', 'download-error']
