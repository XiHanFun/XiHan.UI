...
const PUBLIC_EVENTS = ['open-change', 'checked-change', 'column-preference-change', 'pressed-change', 'row-move', 'value-change', 'select', 'sort', 'status-change', 'submit', 'stop', 'stick-change', 'download-complete', 'download-error']
