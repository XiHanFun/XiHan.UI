...
const PUBLIC_EVENTS = ['open-change', 'checked-change', 'pressed-change', 'value-change', 'select', 'status-change', 'submit', 'stop', 'stick-change', 'download-complete', 'download-error']
