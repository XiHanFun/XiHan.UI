...
// 全局命令式轻提示服务：自带一个挂到 body 的宿主树与默认渲染模板，
...
/** 文案可以传常量，也可以传取值函数：堆叠中的提示条会跨过一次语言切换。 */
    ...
    return (
      <XhConfigProvider config={configSource.read()}>
        <div
          ...
          hidden={items.length === 0 || undefined}
        >
