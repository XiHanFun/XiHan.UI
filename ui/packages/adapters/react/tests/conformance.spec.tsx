...
import { dialogSuite, fieldSuite, formSuite, runConformance, selectSuite, switchSuite } from '@xihan-ui/testing'
...
runConformance(createReactHarness(), [dialogSuite, fieldSuite, formSuite, selectSuite, switchSuite], { describe, it }, {
