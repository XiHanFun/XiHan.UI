import type { SelectionMode, SelectionState } from '../src/behavior/selection/types'
import { describe, expect, it } from 'vitest'
import { applySelection, clearSelection, EMPTY_SELECTION, rangeBetween, toggleSelectAll } from '../src/behavior/selection/select'
