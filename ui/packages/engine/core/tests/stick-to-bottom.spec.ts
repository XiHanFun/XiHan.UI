...
// 验证 stick to bottom 相关行为。

import type { StickToBottomHandle, StickToBottomState } from '../src/behavior/stick-to-bottom'
// @vitest-environment jsdom
import type { RuntimeConfig } from '../src/kernel'
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import { createStickToBottom, STICK_TO_BOTTOM_THRESHOLD } from '../src/behavior/stick-to-bottom'
import { createCounterIdGenerator, createScope } from '../src/kernel'
