...
export const mentionKeyboard: KeyboardTable = {
  ...
  rows: [
    ...
    { id: 'mention.kbd.commit', keys: ['Enter'], when: 'open, 有高亮且未禁用', does: '把候选文本插到光标处替换查询串，光标落到插入内容之后，浮层收起；这次回车被吞掉，不落到表单上' },
    { id: 'mention.kbd.enter-pass', keys: ['Enter'], when: 'open, 无可提交候选', does: '不吞按键，只把浮层收起来；摆在表单里时这次回车照常提交表单' },
