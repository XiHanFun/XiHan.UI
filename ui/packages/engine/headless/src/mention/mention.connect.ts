...
function availableSpaceVars(
  ...
  return {
    '--xh-_mention-available-w': availablePx(placed?.availableWidth, AVAILABLE_W_FLOOR),
    '--xh-_mention-available-h': availablePx(placed?.availableHeight, AVAILABLE_H_FLOOR),
  }
}
