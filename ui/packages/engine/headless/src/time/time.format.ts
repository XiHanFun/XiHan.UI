...
export const TIME_RELATIVE_LIMIT = 30 * DAY
 ...
 */
export function toTimeDate(value: TimeValue | undefined | null): Date | undefined {
  if (value == null)
    return undefined
 ...
 */
export function timeMachineStamp(date: Date, type: TimeType): string {
  return type === 'date'
