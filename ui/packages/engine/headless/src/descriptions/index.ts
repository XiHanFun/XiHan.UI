...
export type { DescriptionsApi, DescriptionsColumns, DescriptionsItemProps, DescriptionsPlacement, DescriptionsProps, DescriptionsTranslations } from './descriptions.types'
