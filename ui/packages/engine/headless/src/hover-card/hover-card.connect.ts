...
function availableSpaceVars(
  ...
  return {
    '--xh-_hover-card-available-w': availablePx(placed?.availableWidth, AVAILABLE_W_FLOOR),
    '--xh-_hover-card-available-h': availablePx(placed?.availableHeight, AVAILABLE_H_FLOOR),
  }
}
