...
export const paginationKeyboard: KeyboardTable = {
  ...
  rows: [
    ...
    { id: 'pagination.kbd.ellipsis', keys: ['Enter', 'Space'], when: 'focus in ellipsis', does: '摊开被折叠的那几页；再按一次收起。纯悬停会把键盘用户挡在外面，而那几页除了这里没有别的入口' },
    { id: 'pagination.kbd.ellipsis-escape', keys: ['Escape'], when: 'ellipsis 已摊开', does: '收起摊开的页码面板（走消解层，点面板外面同样收起）' },
