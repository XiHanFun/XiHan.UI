...
export type { TabsActivationMode, TabsApi, TabsContentProps, TabsNode, TabsNodeMeta, TabsSchema, TabsTranslations, TabsTriggerProps, TabsValueChangeDetails, TabsVariant } from './tabs.types'
