...
// 网格内的方向键、翻页键与确认键见 calendar-picker 键盘表，段位上的按键见 date-field 键盘表。
export const datePickerKeyboard: KeyboardTable = {
  ...
  rows: [
    ...
    { id: 'date-picker.kbd.select', keys: ['Enter', 'Space'], when: 'open, focus in grid', does: '选中聚焦日（由日历完成）；closeOnSelect 时收起浮层，多选不收起' },
