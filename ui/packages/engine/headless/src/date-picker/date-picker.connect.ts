...
function availableSpaceVars(
  ...
  return {
    '--xh-_date-picker-available-w': availablePx(placed?.availableWidth, AVAILABLE_W_FLOOR),
    '--xh-_date-picker-available-h': availablePx(placed?.availableHeight, AVAILABLE_H_FLOOR),
  }
}
