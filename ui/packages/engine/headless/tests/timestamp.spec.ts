...
// 直接从组件目录导入，不经包主入口
import { connectTimestamp, formatRelativeTime, formatTimePattern, timestampMachineStamp, toTimeDate } from '../src/timestamp'

type Dict = Record<string, unknown>

/** 用给定 props 调一次连接层，返回其 API。 */
function api(props: TimestampProps = {}): TimestampApi {
  return connectTimestamp(props, normalizeProps)
}
