 ...
 * @returns 返回脱敏后的值
 */
export const mask = (value: string, start = 3, end = 4): string => {
 ...
 * @returns 返回脱敏后的手机号
 */
export const mobile = (phone: string): string => {
 ...
 * @returns 返回脱敏后的身份证
 */
export const idCard = (id: string): string => {
 ...
 * @returns 返回脱敏后的银行卡
 */
export const bankCard = (card: string): string => {
 ...
 * @returns 返回脱敏后的地址
 */
export const address = (addr: string, keepStart = 6, keepEnd = 0): string => {
