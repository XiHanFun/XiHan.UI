...
export const WiDirectionUpLeft = createIcon({
  name: "wi-direction-up-left",
  path: "M10.03,14.31V9.84c0-0.3,0.1-0.55,0.3-0.75s0.45-0.3,0.74-0.3h4.48c0.29,0,0.54,0.1,0.74,0.3s0.3,0.45,0.3,0.75
