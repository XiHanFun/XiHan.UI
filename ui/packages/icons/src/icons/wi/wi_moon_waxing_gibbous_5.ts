...
export const WiMoonWaxingGibbous5 = createIcon({
  name: "wi-moon-waxing-gibbous-5",
  path: "M9.65,14.43c0,1.24,0.08,2.38,0.25,3.41s0.44,2.05,0.83,3.04s0.95,1.89,1.67,2.71s1.6,1.52,2.62,2.12
