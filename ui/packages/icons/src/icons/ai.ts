...
export const AiZhihuSquareFill = defineComponent({
  name: "ai-zhihu-square-fill",
  setup(props) {
    return () =>
      h(IconBase, { ...props }, [
        h("path", {
...
export const aiDisplayName = "Ant Design Icons";
export const aiCount = 831;
export const aiComponents = [AiZhihuSquareFill];
