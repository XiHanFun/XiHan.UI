...
export type ComponentTokenName =
  ...
  | '--xh-button-group-separator-gap'
  | '--xh-button-group-separator-inset'
  ...
  | '--xh-hotkeys-fg'
  | '--xh-hotkeys-font-size'
  | '--xh-hotkeys-gap'
  | '--xh-hotkeys-key-bg'
  | '--xh-hotkeys-key-bg-disabled'
  | '--xh-hotkeys-key-border'
  | '--xh-hotkeys-key-fg'
  | '--xh-hotkeys-key-fg-modifier'
  | '--xh-hotkeys-key-font'
  | '--xh-hotkeys-key-font-weight'
  | '--xh-hotkeys-key-min-w'
  | '--xh-hotkeys-key-px'
  | '--xh-hotkeys-key-py'
  | '--xh-hotkeys-key-radius'
  | '--xh-hotkeys-key-shadow'
  | '--xh-hotkeys-separator-fg'
