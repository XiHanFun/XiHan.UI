...
export type ComponentTokenName =
  ...
  | '--xh-calendar-picker-today-bg-hover'
  ...
  | '--xh-calendar-range-picker-today-bg-hover'
  ...
  | '--xh-time-range-picker-item-bg-checked'
  | '--xh-time-range-picker-item-bg-checked-hover'
  ...
  | '--xh-time-range-picker-item-fg-checked'
  ...
  | '--xh-time-range-picker-item-weight-checked'
