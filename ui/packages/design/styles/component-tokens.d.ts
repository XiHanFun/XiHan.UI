...
export type ComponentTokenName =
  ...
  | '--xh-calendar-nav-fg'
  | '--xh-calendar-nav-fg-hover'
  | '--xh-calendar-nav-radius'
  | '--xh-calendar-nav-size'
  | '--xh-calendar-period-gap'
  | '--xh-calendar-period-py'
  | '--xh-calendar-period-radius'
  | '--xh-calendar-range-bg'
  | '--xh-calendar-range-cap-radius'
  | '--xh-calendar-range-preview-bg'
  | '--xh-calendar-range-preview-cap-bg'
  | '--xh-calendar-range-preview-cap-fg'
  | '--xh-calendar-range-row-radius'
  | '--xh-calendar-row-gap'
  | '--xh-calendar-today-bg'
  ...
  | '--xh-checkbox-group-indicator-highlight'
  | '--xh-checkbox-group-indicator-radius'
  | '--xh-checkbox-group-indicator-shadow'
  | '--xh-checkbox-group-indicator-shadow-disabled'
  | '--xh-checkbox-group-indicator-shadow-hover'
  | '--xh-checkbox-group-indicator-shadow-pressed'
  | '--xh-checkbox-group-indicator-shadow-readonly'
  ...
  | '--xh-date-picker-range-separator-fg'
  | '--xh-date-picker-range-separator-px'
  ...
  | '--xh-number-field-control-bg-focus'
  | '--xh-number-field-control-bg-hover'
  | '--xh-number-field-control-bg-invalid'
  ...
  | '--xh-steps-indicator-bg-error'
  | '--xh-steps-indicator-bg-hover'
  | '--xh-steps-indicator-bg-warning'
  ...
  | '--xh-time-picker-item-bg-checked'
  | '--xh-time-picker-item-bg-checked-hover'
