...
/**
 * Descriptions 组件的尺寸类型
 */
export type DescriptionsSize = 'small' | 'medium' | 'large'

/**
 * Descriptions 组件的主题类型
 */
export type DescriptionsType = 'default' | 'primary' | 'success' | 'warning' | 'error'

/**
 * Descriptions 组件的 Props 定义
 */
